# Vendored from github.com/stawel/ht301_hacklib at 2f1498d (ht301_hacklib.py, unmodified below
# this header). GPL-3.0; used only by tools/py/oracle.py as the M2 temperature oracle
# (docs/PLAN.md). Never construct Camera(): it opens any attached camera and sends 0x8004 and
# 0x8000 outside our command gate. Only CameraEmulator is used.
